...
const mediaURL = "http://192.168.100.7:8000"
...
const MoviesScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        axiosInstance.get('category/MOV/')
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.mainTitle}>Available</Text>
            <Text style={styles.mainTitle}>and Latest Movies</Text>
